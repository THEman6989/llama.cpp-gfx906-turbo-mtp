...
#define FATTN_VEC_CUSTOM_CASE(D, type_K_case, type_V_case)                                                        \
    if (head_size == (D) && type_K == type_K_case && type_V == type_V_case) {                                    \
        return ggml_cuda_flash_attn_ext_vec_case<D, type_K_case, type_V_case>;                                    \
    }                                                                                                             \

#define FATTN_VEC_CUSTOM_CASES_ALL_D(type_K_case, type_V_case) \
    FATTN_VEC_CUSTOM_CASE( 64, type_K_case, type_V_case)       \
    FATTN_VEC_CUSTOM_CASE(128, type_K_case, type_V_case)       \
    FATTN_VEC_CUSTOM_CASE(256, type_K_case, type_V_case)       \
    FATTN_VEC_CUSTOM_CASE(512, type_K_case, type_V_case)       \
...
static fattn_vec_case_t ggml_cuda_get_fattn_vec_case(const int64_t head_size, const ggml_type type_K, const ggml_type type_V) {
    ...
    FATTN_VEC_CUSTOM_CASES_ALL_D(GGML_TYPE_TURBO3_0, GGML_TYPE_F16)
    FATTN_VEC_CUSTOM_CASES_ALL_D(GGML_TYPE_TURBO3_0, GGML_TYPE_TURBO3_0)
    FATTN_VEC_CUSTOM_CASES_ALL_D(GGML_TYPE_TURBO3_0, GGML_TYPE_Q8_0)
    FATTN_VEC_CUSTOM_CASES_ALL_D(GGML_TYPE_TURBO4_0, GGML_TYPE_TURBO4_0)
    FATTN_VEC_CUSTOM_CASES_ALL_D(GGML_TYPE_TURBO2_0, GGML_TYPE_TURBO2_0)
...
static best_fattn_kernel ggml_cuda_get_best_fattn_kernel(const int device, const ggml_tensor * dst) {
    ...
    if (K->type == GGML_TYPE_Q8_0 && V->type == GGML_TYPE_Q8_0 && Q->ne[0] <= 256) {
