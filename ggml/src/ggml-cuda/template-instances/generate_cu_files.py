...
for head_size_kq in HEAD_SIZES_KQ:
    ...
    if head_size_kq == 576: head_size_v = 512
    if head_size_kq == 320: head_size_v = 256
    if head_size_kq == 192: head_size_v = 128
    ...
    for ncols2 in [1, 2, 4, 8, 16, 32]:
        ...
        with open(f"fattn-mma-f16-instance-ncols1_{ncols1}-ncols2_{ncols2}.cu", "w") as f:
            ...
            for head_size_kq in HEAD_SIZES_KQ:
                ...
                # Filter logic to match fattn.cu requirements
                if head_size_kq not in (320, 576) and ncols2 in (16, 32):
                    continue
                if head_size_kq == 576 and ncols2 not in (4, 16, 32):
                    continue
                if head_size_kq == 320 and ncols2 != 32:
                    continue
                if head_size_kq == 192 and ncols2 not in (8, 16):
                    continue
